...
import com.foldy.domain.stats.dto.ActivityResponseDto;
import com.foldy.domain.stats.dto.SummaryRequestDto;
import com.foldy.domain.stats.dto.SummaryResponseDto;
import com.foldy.domain.stats.dto.TagStatResponseDto;
...
public class StatsService {
    ...
    public SummaryResponseDto getAiSummary(SummaryRequestDto request) {
        // TODO: 실제 구현 시에는 request.getMemoIds()를 이용해 JPA로 메모 본문들을 이어붙여(String) 가져옵니다.
